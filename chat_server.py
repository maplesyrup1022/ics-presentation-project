            ...
            if len(msg) > 0:
                ...
                if msg["action"] == "login":
                    ...
                    if self.group.is_member(name) != True:
                        ...
                        self.logged_name2ppn [name] = msg['ppn'] #modified
        ...
        if len(msg) > 0:
            ...
            if msg["action"] == "connect":
                ...
                # connect to the peer
                    ...
                    from_ppn = self.logged_name2ppn[from_name] #modified
                    to_ppn = self.logged_name2ppn[to_name]
                    
                    for g in the_guys[1:]:
                        to_sock = self.logged_name2sock[g]
    
                        mysend(to_sock, json.dumps(
                            {"action": "connect", "status": "request", "from": from_name, 'from_ppn': from_ppn })) #modified
                    msg = json.dumps(
                        {"action": "connect", "status": "success", 'to_ppn': to_ppn}) #modified
                else:
                    msg = json.dumps(
